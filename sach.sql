...
GO
INSERT [dbo].[Sach] ([MaSach], [TenSach],  [MoTa], [NgayCapNhat], [MaNXB], [Image]) VALUES (9, N'C# Dành Cho Người Tự Học - Tập 1', N'Sách được chia thành 11 bài, từ căn bản đến nâng cao kèm theo CD bài tập thực hành nhằm giúp bạn học một cách nhanh chóng và dễ hiểu như:', CAST(N'2012-03-31 00:00:00.000' AS DateTime), 1, N'C# Tự Học 1.jpg')
GO
INSERT [dbo].[Sach] ([MaSach], [TenSach],  [MoTa], [NgayCapNhat], [MaNXB], [Image]) VALUES (10, N'C# Dành Cho Người Tự Học - Tập 2', N'Trong tập 2 này, các bạn sẽ tìm hiểu ứng dụng C# trong Windows Form qua 2 phần, mỗi phần là một bài tập lớn xây dựng lên ứng dụng Quản lý bán hàng và Quản lý tuyển sinh để bạn đọc hiểu rõ và khai thác có hiệu quả những công cụ và lệnh của C# đã trình bày trong tập 1.', CAST(N'2012-03-31 00:00:00.000' AS DateTime), 1, N'C# Tự Học 2.png')
GO
INSERT [dbo].[Sach] ([MaSach], [TenSach],  [MoTa], [NgayCapNhat], [MaNXB], [Image]) VALUES (11, N'Nghệ Thuật Sống An Lạc ', N'"Nghệ thuật sống An lạc là tuyển tập các bài giảng liên quan tới chủ đề nghệ thuật sống của Đức Nhiếp Chính Vương Khamtrul Rinpoche đời thứ IX Jigme Pema Nyinjadh . ', CAST(N'2012-03-31 00:00:00.000' AS DateTime),4, N'Nghệ Thuật Sống An Lạc.jpg')
GO
...
BEGIN
	...
	VALUES (@Username, PWDENCRYPT(@UserPass))
